    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
            ...
            @Override public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(MainActivity.this.getApplicationContext(),
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivity.this,
                        ...
                        // 拒绝权限
                        ToastUtil.getInstance()._short(MainActivity.this.getApplicationContext(), getString(R.string.big_image_no_auth_show_pic));
                    } else {
                        // 申请权限
        ...
        findViewById(R.id.buttonClean).setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ...
                ToastUtil.getInstance()._short(MainActivity.this, getString(R.string.big_image_disk_clear));
            }
        });
    }
